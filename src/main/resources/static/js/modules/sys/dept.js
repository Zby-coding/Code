...
Dept.initColumn = function () {
    var columns = [
        ...
        {title: '班级ID', field: 'deptId', visible: false, align: 'center', valign: 'middle', width: '50px'},
        {title: '班级名称', field: 'name', align: 'center', valign: 'middle', sortable: true, width: '180px'},
        {title: '上级班级', field: 'parentName', align: 'center', valign: 'middle', sortable: true, width: '100px'},
